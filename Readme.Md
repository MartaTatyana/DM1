##Predicting Eruption duration for Old Faithful
...
### Eruption Duration predictions

This is a very basica applicaiton that predict roughly the duration of eruption based on the wait time between the occurances.


THe app allows to navigate between different wait times through use of slider. It shows wha the predicted duration time will be, and slow show it on the graph that is based on the avaliable historical data.